...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='G729A Encoding File Parameter Extraction Tool')
    parser.add_argument("--input", default="/data/fangzhengyang/VStego800K-main/Steganalysis/Voip_retest/data/input/g729a/ws/steg/PMS_0.1s", help="Input files/folders", type=str)
    parser.add_argument("--output", default="/data/fangzhengyang/VStego800K-main/Steganalysis/Voip_retest/data/output_txt/ws/PMS/PMS_0.1s/Steg", help="Output Folder", type=str)
    parser.add_argument("-t", "--type", help="Output type (G729A or FEAT, default FEAT)", type=str, default=Feature)
    ...
    if args.type.lower() == G729A.lower():
        ...
        print_error("The input parameter type must be G729A or FEAT")
        exit(1)
